...
module.exports = {
    ...
    transform: {
        ...
        // uuid v14). Jest's CommonJS runtime chokes on their `export`
        // statements, so they must go through the transform rather than being
    ...
    // Packages that publish ESM only, so Jest's CJS runtime must transform
    // them instead of skipping node_modules wholesale:
